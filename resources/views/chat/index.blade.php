...
<div class="container">
    ...
    <h2 class="pull-left" style="margin:10px 0">{{$board->title}}</h2>
    <a href="{{route('boards.index')}}" class="pull-right btn btn-lg btn-success" style="margin:10px 0">一覧に戻る</a>
    <div style="clear:both"></div>
    <hr style="border: black solid 1px; margin:10px 0;">
    {{Form::open(['route' => 'chat.store', 'class' => 'form-group'])}}
        ...
        <input class="form-control btn-primary pull-right" style="margin:10px 0" type="submit" name="submit" value="送信">
    {{Form::close()}}
    <div style="clear:both"></div>
